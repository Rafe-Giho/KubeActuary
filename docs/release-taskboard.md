...
| 0.6.1 | kube-linter and kube-score evidence adapters | DOING | kube-linter done via `scripts/verify_kube_linter_adapter.py`; kube-score remains |
...
| Version | Task | Status | Verification |
| --- | --- | --- | --- |
| 0.8.0 | Validating admission webhook prototype | TODO | kind smoke, default `failurePolicy: Ignore` |
| 0.8.1 | AI identity selector and annotation requirements | TODO | admission allow/deny tests |
