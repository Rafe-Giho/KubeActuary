...
| Version worklist | DONE | `scripts/generate_version_worklist.py`, `scripts/prepare_version_iteration.py`, `scripts/compare_version_iterations.py`, `scripts/record_version_iteration.py`, and `scripts/verify_version_worklist.py` verify schemas `kube-actuary.version-worklist.v1`, `kube-actuary.version-iteration.v1`, `kube-actuary.version-iteration-diff.v1`, and `kube-actuary.version-iteration-history.v1` for version-grouped open work, local iteration packs, pack diffs, and run history |
